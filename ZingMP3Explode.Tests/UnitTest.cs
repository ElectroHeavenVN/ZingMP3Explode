    ...
    public class UnitTest
    {
        ...
        public void TestGetSong()
        {
            Task.Run(async () =>
            {
                ...
                var song = await client.Songs.GetAsync("https://zingmp3.vn/bai-hat/Keo-Bong-Gon-Minh-Khon-Remix-H2K-HHD/Z60WDZB0.html");
        ...
        public void TestGetArtist()
        {
            Task.Run(async () =>
            {
                ZingMP3Client client = new ZingMP3Client();
                await client.InitializeAsync();
                var artist = await client.Artists.GetAsync("https://zingmp3.vn/Alan-Walker");
        ...
        public void TestGetAlbum()
        {
            Task.Run(async () =>
            {
                ZingMP3Client client = new ZingMP3Client();
                await client.InitializeAsync();
                var album = await client.Albums.GetAsync("https://zingmp3.vn/album/Fake-A-Smile-Remixes-EP-Alan-Walker-salem-ilese/676CZZ80.html");
        ...
        public void TestGetMV()
        {
            Task.Run(async () =>
            {
                ZingMP3Client client = new ZingMP3Client();
                await client.InitializeAsync();
                var mv = await client.Videos.GetAsync("https://zingmp3.vn/video-clip/Thang-Nam-Khong-Quen-EDM-Version-H2K-DJ-Eric-T-J/ZWAEWFCU.html");
        ...
        public void TestGetGenre()
        {
            Task.Run(async () =>
            {
                ZingMP3Client client = new ZingMP3Client();
                await client.InitializeAsync();
                var genre = await client.Genres.GetAsync("IWZ9Z08I");
