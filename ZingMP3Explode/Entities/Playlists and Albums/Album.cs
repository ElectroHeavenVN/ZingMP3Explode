...
{
    /// <summary>
    /// <para xml:lang="en">Information about an album.</para>
    /// <para xml:lang="vi">Thông tin về một album.</para>
    /// </summary>
    public class Album : BaseList
    {
        [JsonConstructor]
        internal Album() { }

        internal Album(BaseList baseList)
        {
            ID = baseList.ID;
